...
ir82 = 90.0
ir83 = 100.0
ar1 compress ar8, ar3, ir81, ir82, ir82, ir83, ir81, ir81, 0.0
ar8 = (ar1 * 0.8)
arl0 = ar8
ar1 = (0.75 * ar9)
ar8 = (ar9 + ar7)
...
ar1 = (ar8 + ar10)
ar7 = (ar1 + ar10)
ar1 compress ar7, ar3, ir81, ir82, ir82, ir83, ir81, ir81, 0.0
ar3 = (ar1 * 0.8)
arl1 = ar3
ar1 = arl0
ar3 = arl1
...
ir9 = 8.1
ir10 = cpspch(ir9)
 event_i "i", 24, 0.0, 1.5, 0.5, ir10, ir5
ir13 = 9.0
ir14 = cpspch(ir13)
 event_i "i", 24, 1.5, 0.5, 0.5, ir14, ir5
ir17 = 9.01
ir18 = cpspch(ir17)
 event_i "i", 24, 2.0, 0.5, 0.5, ir18, ir5
ir21 = 9.03
ir22 = cpspch(ir21)
 event_i "i", 24, 2.5, 0.5, 0.5, ir22, ir5
ir25 = 9.05
ir26 = cpspch(ir25)
 event_i "i", 24, 3.0, 2.75, 0.5, ir26, ir5
 event_i "i", 24, 5.75, 0.25, 0.5, ir26, ir5
ir31 = 9.04
ir32 = cpspch(ir31)
 event_i "i", 24, 6.0, 1.25, 0.5, ir32, ir5
 event_i "i", 24, 7.25, 0.25, 0.5, ir26, ir5
 event_i "i", 24, 7.5, 1.25, 0.5, ir14, ir5
 event_i "i", 24, 8.75, 0.25, 0.5, ir10, ir5
ir41 = 8.08
ir42 = cpspch(ir41)
 event_i "i", 24, 9.0, 2.0, 0.5, ir42, ir5
ir45 = 8.0
ir46 = cpspch(ir45)
 event_i "i", 24, 11.0, 0.5, 0.5, ir46, ir5
ir49 = 8.01
ir50 = cpspch(ir49)
 event_i "i", 24, 11.5, 0.5, 0.5, ir50, ir5
 event_i "i", 24, 12.0, 1.75, 0.5, ir10, ir5
 event_i "i", 24, 13.75, 0.5, 0.5, ir14, ir5
 event_i "i", 24, 14.25, 0.5, 0.5, ir18, ir5
 event_i "i", 24, 14.75, 0.5, 0.5, ir22, ir5
 event_i "i", 24, 15.25, 2.75, 0.5, ir18, ir5
 event_i "i", 24, 18.0, 0.25, 0.5, ir14, ir5
ir65 = 8.07
ir66 = cpspch(ir65)
 event_i "i", 24, 18.25, 1.0, 0.5, ir66, ir5
ir69 = 8.05
ir70 = cpspch(ir69)
 event_i "i", 24, 19.25, 0.25, 0.5, ir70, ir5
 event_i "i", 24, 19.5, 1.25, 0.5, ir42, ir5
 event_i "i", 24, 20.75, 0.25, 0.5, ir66, ir5
 event_i "i", 24, 21.0, 2.0, 0.5, ir70, ir5
krl0 = 2.0
kr0 = krl0
S83 sprintf "alive_%d", ir5
 chnset kr0, S83
ir86 FreePort 
 event_i "i", 22, 24.0, 24.0, ir86, ir1
 event_i "i", 24, 24.0, 1.5, 0.5, ir10, ir86
 event_i "i", 24, 25.5, 0.5, 0.5, ir14, ir86
 event_i "i", 24, 26.0, 0.5, 0.5, ir18, ir86
 event_i "i", 24, 26.5, 0.5, 0.5, ir22, ir86
 event_i "i", 24, 27.0, 2.75, 0.5, ir26, ir86
 event_i "i", 24, 29.75, 0.25, 0.5, ir26, ir86
 event_i "i", 24, 30.0, 1.25, 0.5, ir32, ir86
 event_i "i", 24, 31.25, 0.25, 0.5, ir26, ir86
 event_i "i", 24, 31.5, 1.25, 0.5, ir14, ir86
 event_i "i", 24, 32.75, 0.25, 0.5, ir10, ir86
 event_i "i", 24, 33.0, 2.0, 0.5, ir42, ir86
 event_i "i", 24, 35.0, 0.5, 0.5, ir46, ir86
 event_i "i", 24, 35.5, 0.5, 0.5, ir50, ir86
 event_i "i", 24, 36.0, 1.75, 0.5, ir10, ir86
 event_i "i", 24, 37.75, 0.5, 0.5, ir14, ir86
 event_i "i", 24, 38.25, 0.5, 0.5, ir18, ir86
 event_i "i", 24, 38.75, 0.5, 0.5, ir22, ir86
 event_i "i", 24, 39.25, 2.75, 0.5, ir18, ir86
 event_i "i", 24, 42.0, 0.25, 0.5, ir14, ir86
 event_i "i", 24, 42.25, 1.0, 0.5, ir66, ir86
 event_i "i", 24, 43.25, 0.25, 0.5, ir70, ir86
 event_i "i", 24, 43.5, 1.25, 0.5, ir42, ir86
 event_i "i", 24, 44.75, 0.25, 0.5, ir66, ir86
 event_i "i", 24, 45.0, 2.0, 0.5, ir70, ir86
krl0 = 2.0
kr0 = krl0
S142 sprintf "alive_%d", ir86
 chnset kr0, S142
ir145 FreePort 
 event_i "i", 22, 48.0, 24.0, ir145, ir1
 event_i "i", 24, 48.0, 1.5, 0.5, ir10, ir145
 event_i "i", 24, 49.5, 0.5, 0.5, ir14, ir145
 event_i "i", 24, 50.0, 0.5, 0.5, ir18, ir145
 event_i "i", 24, 50.5, 0.5, 0.5, ir22, ir145
 event_i "i", 24, 51.0, 2.75, 0.5, ir26, ir145
 event_i "i", 24, 53.75, 0.25, 0.5, ir26, ir145
 event_i "i", 24, 54.0, 1.25, 0.5, ir32, ir145
 event_i "i", 24, 55.25, 0.25, 0.5, ir26, ir145
 event_i "i", 24, 55.5, 1.25, 0.5, ir14, ir145
 event_i "i", 24, 56.75, 0.25, 0.5, ir10, ir145
 event_i "i", 24, 57.0, 2.0, 0.5, ir42, ir145
 event_i "i", 24, 59.0, 0.5, 0.5, ir46, ir145
 event_i "i", 24, 59.5, 0.5, 0.5, ir50, ir145
 event_i "i", 24, 60.0, 1.75, 0.5, ir10, ir145
 event_i "i", 24, 61.75, 0.5, 0.5, ir14, ir145
 event_i "i", 24, 62.25, 0.5, 0.5, ir18, ir145
 event_i "i", 24, 62.75, 0.5, 0.5, ir22, ir145
 event_i "i", 24, 63.25, 2.75, 0.5, ir18, ir145
 event_i "i", 24, 66.0, 0.25, 0.5, ir14, ir145
 event_i "i", 24, 66.25, 1.0, 0.5, ir66, ir145
 event_i "i", 24, 67.25, 0.25, 0.5, ir70, ir145
 event_i "i", 24, 67.5, 1.25, 0.5, ir42, ir145
 event_i "i", 24, 68.75, 0.25, 0.5, ir66, ir145
 event_i "i", 24, 69.0, 2.0, 0.5, ir70, ir145
krl0 = 2.0
kr0 = krl0
S201 sprintf "alive_%d", ir145
 chnset kr0, S201
ir204 FreePort 
 event_i "i", 22, 72.0, 24.0, ir204, ir1
 event_i "i", 24, 72.0, 1.5, 0.5, ir10, ir204
 event_i "i", 24, 73.5, 0.5, 0.5, ir14, ir204
 event_i "i", 24, 74.0, 0.5, 0.5, ir18, ir204
 event_i "i", 24, 74.5, 0.5, 0.5, ir22, ir204
 event_i "i", 24, 75.0, 2.75, 0.5, ir26, ir204
 event_i "i", 24, 77.75, 0.25, 0.5, ir26, ir204
 event_i "i", 24, 78.0, 1.25, 0.5, ir32, ir204
 event_i "i", 24, 79.25, 0.25, 0.5, ir26, ir204
 event_i "i", 24, 79.5, 1.25, 0.5, ir14, ir204
 event_i "i", 24, 80.75, 0.25, 0.5, ir10, ir204
 event_i "i", 24, 81.0, 2.0, 0.5, ir42, ir204
 event_i "i", 24, 83.0, 0.5, 0.5, ir46, ir204
 event_i "i", 24, 83.5, 0.5, 0.5, ir50, ir204
 event_i "i", 24, 84.0, 1.75, 0.5, ir10, ir204
 event_i "i", 24, 85.75, 0.5, 0.5, ir14, ir204
 event_i "i", 24, 86.25, 0.5, 0.5, ir18, ir204
 event_i "i", 24, 86.75, 0.5, 0.5, ir22, ir204
 event_i "i", 24, 87.25, 2.75, 0.5, ir18, ir204
 event_i "i", 24, 90.0, 0.25, 0.5, ir14, ir204
 event_i "i", 24, 90.25, 1.0, 0.5, ir66, ir204
 event_i "i", 24, 91.25, 0.25, 0.5, ir70, ir204
 event_i "i", 24, 91.5, 1.25, 0.5, ir42, ir204
 event_i "i", 24, 92.75, 0.25, 0.5, ir66, ir204
 event_i "i", 24, 93.0, 2.0, 0.5, ir70, ir204
krl0 = 2.0
kr0 = krl0
S260 sprintf "alive_%d", ir204
 chnset kr0, S260
ir263 FreePort 
 event_i "i", 22, 96.0, 24.0, ir263, ir1
 event_i "i", 24, 96.0, 1.5, 0.5, ir10, ir263
 event_i "i", 24, 97.5, 0.5, 0.5, ir14, ir263
 event_i "i", 24, 98.0, 0.5, 0.5, ir18, ir263
 event_i "i", 24, 98.5, 0.5, 0.5, ir22, ir263
 event_i "i", 24, 99.0, 2.75, 0.5, ir26, ir263
 event_i "i", 24, 101.75, 0.25, 0.5, ir26, ir263
 event_i "i", 24, 102.0, 1.25, 0.5, ir32, ir263
 event_i "i", 24, 103.25, 0.25, 0.5, ir26, ir263
 event_i "i", 24, 103.5, 1.25, 0.5, ir14, ir263
 event_i "i", 24, 104.75, 0.25, 0.5, ir10, ir263
 event_i "i", 24, 105.0, 2.0, 0.5, ir42, ir263
 event_i "i", 24, 107.0, 0.5, 0.5, ir46, ir263
 event_i "i", 24, 107.5, 0.5, 0.5, ir50, ir263
 event_i "i", 24, 108.0, 1.75, 0.5, ir10, ir263
 event_i "i", 24, 109.75, 0.5, 0.5, ir14, ir263
 event_i "i", 24, 110.25, 0.5, 0.5, ir18, ir263
 event_i "i", 24, 110.75, 0.5, 0.5, ir22, ir263
 event_i "i", 24, 111.25, 2.75, 0.5, ir18, ir263
 event_i "i", 24, 114.0, 0.25, 0.5, ir14, ir263
 event_i "i", 24, 114.25, 1.0, 0.5, ir66, ir263
 event_i "i", 24, 115.25, 0.25, 0.5, ir70, ir263
 event_i "i", 24, 115.5, 1.25, 0.5, ir42, ir263
 event_i "i", 24, 116.75, 0.25, 0.5, ir66, ir263
 event_i "i", 24, 117.0, 2.0, 0.5, ir70, ir263
krl0 = 2.0
kr0 = krl0
S319 sprintf "alive_%d", ir263
 chnset kr0, S319
ir322 FreePort 
 event_i "i", 22, 120.0, 24.0, ir322, ir1
 event_i "i", 24, 120.0, 1.5, 0.5, ir10, ir322
 event_i "i", 24, 121.5, 0.5, 0.5, ir14, ir322
 event_i "i", 24, 122.0, 0.5, 0.5, ir18, ir322
 event_i "i", 24, 122.5, 0.5, 0.5, ir22, ir322
 event_i "i", 24, 123.0, 2.75, 0.5, ir26, ir322
 event_i "i", 24, 125.75, 0.25, 0.5, ir26, ir322
 event_i "i", 24, 126.0, 1.25, 0.5, ir32, ir322
 event_i "i", 24, 127.25, 0.25, 0.5, ir26, ir322
 event_i "i", 24, 127.5, 1.25, 0.5, ir14, ir322
 event_i "i", 24, 128.75, 0.25, 0.5, ir10, ir322
 event_i "i", 24, 129.0, 2.0, 0.5, ir42, ir322
 event_i "i", 24, 131.0, 0.5, 0.5, ir46, ir322
 event_i "i", 24, 131.5, 0.5, 0.5, ir50, ir322
 event_i "i", 24, 132.0, 1.75, 0.5, ir10, ir322
 event_i "i", 24, 133.75, 0.5, 0.5, ir14, ir322
 event_i "i", 24, 134.25, 0.5, 0.5, ir18, ir322
 event_i "i", 24, 134.75, 0.5, 0.5, ir22, ir322
 event_i "i", 24, 135.25, 2.75, 0.5, ir18, ir322
 event_i "i", 24, 138.0, 0.25, 0.5, ir14, ir322
 event_i "i", 24, 138.25, 1.0, 0.5, ir66, ir322
 event_i "i", 24, 139.25, 0.25, 0.5, ir70, ir322
 event_i "i", 24, 139.5, 1.25, 0.5, ir42, ir322
 event_i "i", 24, 140.75, 0.25, 0.5, ir66, ir322
 event_i "i", 24, 141.0, 2.0, 0.5, ir70, ir322
krl0 = 2.0
kr0 = krl0
S378 sprintf "alive_%d", ir322
 chnset kr0, S378
ir381 FreePort 
 event_i "i", 22, 144.0, 24.0, ir381, ir1
 event_i "i", 24, 144.0, 1.5, 0.5, ir10, ir381
 event_i "i", 24, 145.5, 0.5, 0.5, ir14, ir381
 event_i "i", 24, 146.0, 0.5, 0.5, ir18, ir381
 event_i "i", 24, 146.5, 0.5, 0.5, ir22, ir381
 event_i "i", 24, 147.0, 2.75, 0.5, ir26, ir381
 event_i "i", 24, 149.75, 0.25, 0.5, ir26, ir381
 event_i "i", 24, 150.0, 1.25, 0.5, ir32, ir381
 event_i "i", 24, 151.25, 0.25, 0.5, ir26, ir381
 event_i "i", 24, 151.5, 1.25, 0.5, ir14, ir381
 event_i "i", 24, 152.75, 0.25, 0.5, ir10, ir381
 event_i "i", 24, 153.0, 2.0, 0.5, ir42, ir381
 event_i "i", 24, 155.0, 0.5, 0.5, ir46, ir381
 event_i "i", 24, 155.5, 0.5, 0.5, ir50, ir381
 event_i "i", 24, 156.0, 1.75, 0.5, ir10, ir381
 event_i "i", 24, 157.75, 0.5, 0.5, ir14, ir381
 event_i "i", 24, 158.25, 0.5, 0.5, ir18, ir381
 event_i "i", 24, 158.75, 0.5, 0.5, ir22, ir381
 event_i "i", 24, 159.25, 2.75, 0.5, ir18, ir381
 event_i "i", 24, 162.0, 0.25, 0.5, ir14, ir381
 event_i "i", 24, 162.25, 1.0, 0.5, ir66, ir381
 event_i "i", 24, 163.25, 0.25, 0.5, ir70, ir381
 event_i "i", 24, 163.5, 1.25, 0.5, ir42, ir381
 event_i "i", 24, 164.75, 0.25, 0.5, ir66, ir381
 event_i "i", 24, 165.0, 2.0, 0.5, ir70, ir381
krl0 = 2.0
kr0 = krl0
S437 sprintf "alive_%d", ir381
 chnset kr0, S437
ir440 FreePort 
 event_i "i", 22, 168.0, 24.0, ir440, ir1
 event_i "i", 24, 168.0, 1.5, 0.5, ir10, ir440
 event_i "i", 24, 169.5, 0.5, 0.5, ir14, ir440
 event_i "i", 24, 170.0, 0.5, 0.5, ir18, ir440
 event_i "i", 24, 170.5, 0.5, 0.5, ir22, ir440
 event_i "i", 24, 171.0, 2.75, 0.5, ir26, ir440
 event_i "i", 24, 173.75, 0.25, 0.5, ir26, ir440
 event_i "i", 24, 174.0, 1.25, 0.5, ir32, ir440
 event_i "i", 24, 175.25, 0.25, 0.5, ir26, ir440
 event_i "i", 24, 175.5, 1.25, 0.5, ir14, ir440
 event_i "i", 24, 176.75, 0.25, 0.5, ir10, ir440
 event_i "i", 24, 177.0, 2.0, 0.5, ir42, ir440
 event_i "i", 24, 179.0, 0.5, 0.5, ir46, ir440
 event_i "i", 24, 179.5, 0.5, 0.5, ir50, ir440
 event_i "i", 24, 180.0, 1.75, 0.5, ir10, ir440
 event_i "i", 24, 181.75, 0.5, 0.5, ir14, ir440
 event_i "i", 24, 182.25, 0.5, 0.5, ir18, ir440
 event_i "i", 24, 182.75, 0.5, 0.5, ir22, ir440
 event_i "i", 24, 183.25, 2.75, 0.5, ir18, ir440
 event_i "i", 24, 186.0, 0.25, 0.5, ir14, ir440
 event_i "i", 24, 186.25, 1.0, 0.5, ir66, ir440
 event_i "i", 24, 187.25, 0.25, 0.5, ir70, ir440
 event_i "i", 24, 187.5, 1.25, 0.5, ir42, ir440
 event_i "i", 24, 188.75, 0.25, 0.5, ir66, ir440
 event_i "i", 24, 189.0, 2.0, 0.5, ir70, ir440
krl0 = 2.0
kr0 = krl0
S496 sprintf "alive_%d", ir440
 chnset kr0, S496
ir499 FreePort 
 event_i "i", 22, 192.0, 24.0, ir499, ir1
 event_i "i", 24, 192.0, 1.5, 0.5, ir10, ir499
 event_i "i", 24, 193.5, 0.5, 0.5, ir14, ir499
 event_i "i", 24, 194.0, 0.5, 0.5, ir18, ir499
 event_i "i", 24, 194.5, 0.5, 0.5, ir22, ir499
 event_i "i", 24, 195.0, 2.75, 0.5, ir26, ir499
 event_i "i", 24, 197.75, 0.25, 0.5, ir26, ir499
 event_i "i", 24, 198.0, 1.25, 0.5, ir32, ir499
 event_i "i", 24, 199.25, 0.25, 0.5, ir26, ir499
 event_i "i", 24, 199.5, 1.25, 0.5, ir14, ir499
 event_i "i", 24, 200.75, 0.25, 0.5, ir10, ir499
 event_i "i", 24, 201.0, 2.0, 0.5, ir42, ir499
 event_i "i", 24, 203.0, 0.5, 0.5, ir46, ir499
 event_i "i", 24, 203.5, 0.5, 0.5, ir50, ir499
 event_i "i", 24, 204.0, 1.75, 0.5, ir10, ir499
 event_i "i", 24, 205.75, 0.5, 0.5, ir14, ir499
 event_i "i", 24, 206.25, 0.5, 0.5, ir18, ir499
 event_i "i", 24, 206.75, 0.5, 0.5, ir22, ir499
 event_i "i", 24, 207.25, 2.75, 0.5, ir18, ir499
 event_i "i", 24, 210.0, 0.25, 0.5, ir14, ir499
 event_i "i", 24, 210.25, 1.0, 0.5, ir66, ir499
 event_i "i", 24, 211.25, 0.25, 0.5, ir70, ir499
 event_i "i", 24, 211.5, 1.25, 0.5, ir42, ir499
 event_i "i", 24, 212.75, 0.25, 0.5, ir66, ir499
 event_i "i", 24, 213.0, 2.0, 0.5, ir70, ir499
krl0 = 2.0
kr0 = krl0
S555 sprintf "alive_%d", ir499
 chnset kr0, S555
ir558 FreePort 
 event_i "i", 22, 216.0, 24.0, ir558, ir1
 event_i "i", 24, 216.0, 1.5, 0.5, ir10, ir558
 event_i "i", 24, 217.5, 0.5, 0.5, ir14, ir558
 event_i "i", 24, 218.0, 0.5, 0.5, ir18, ir558
 event_i "i", 24, 218.5, 0.5, 0.5, ir22, ir558
 event_i "i", 24, 219.0, 2.75, 0.5, ir26, ir558
 event_i "i", 24, 221.75, 0.25, 0.5, ir26, ir558
 event_i "i", 24, 222.0, 1.25, 0.5, ir32, ir558
 event_i "i", 24, 223.25, 0.25, 0.5, ir26, ir558
 event_i "i", 24, 223.5, 1.25, 0.5, ir14, ir558
 event_i "i", 24, 224.75, 0.25, 0.5, ir10, ir558
 event_i "i", 24, 225.0, 2.0, 0.5, ir42, ir558
 event_i "i", 24, 227.0, 0.5, 0.5, ir46, ir558
 event_i "i", 24, 227.5, 0.5, 0.5, ir50, ir558
 event_i "i", 24, 228.0, 1.75, 0.5, ir10, ir558
 event_i "i", 24, 229.75, 0.5, 0.5, ir14, ir558
 event_i "i", 24, 230.25, 0.5, 0.5, ir18, ir558
 event_i "i", 24, 230.75, 0.5, 0.5, ir22, ir558
 event_i "i", 24, 231.25, 2.75, 0.5, ir18, ir558
 event_i "i", 24, 234.0, 0.25, 0.5, ir14, ir558
 event_i "i", 24, 234.25, 1.0, 0.5, ir66, ir558
 event_i "i", 24, 235.25, 0.25, 0.5, ir70, ir558
 event_i "i", 24, 235.5, 1.25, 0.5, ir42, ir558
 event_i "i", 24, 236.75, 0.25, 0.5, ir66, ir558
 event_i "i", 24, 237.0, 2.0, 0.5, ir70, ir558
krl0 = 2.0
kr0 = krl0
...
ir21 = p5
ir22 = 3.0
kr0 oscil3 ir20, kr1, 46
kr3 = (0.5 * kr0)
kr0 = (0.5 + kr3)
kr3 = (kr5 * kr0)
ar1 foscili ir20, ir21, ir20, ir22, kr3, 46
kr0 = (kr1 + 0.2)
kr3 oscil3 ir20, kr0, 46
kr0 = (0.5 * kr3)
kr3 = (0.5 + kr0)
kr0 = (kr2 * kr3)
ar3 foscili ir20, ir21, ir22, ir20, kr0, 46
ar4 = (ar1 + ar3)
ir35 = 7.0
kr0 = (kr1 - 0.15)
kr1 oscil3 ir20, kr0, 46
kr0 = (0.5 * kr1)
kr1 = (0.5 + kr0)
kr0 = (kr5 * kr1)
ar1 foscili ir20, ir21, ir20, ir35, kr0, 46
ar3 = (ar4 + ar1)
ar1 = (ar3 / 3.0)
kr0 = (2.0 * p5)
kr1 = (1000.0 + kr0)
...
ir9 = 8.05
ir10 = cpspch(ir9)
 event_i "i", 21, 0.0, 1.25, 0.4, ir10, ir5
ir13 = 9.0
ir14 = cpspch(ir13)
 event_i "i", 21, 1.25, 0.25, 0.4, ir14, ir5
ir17 = 8.1
ir18 = cpspch(ir17)
 event_i "i", 21, 1.5, 1.25, 0.4, ir18, ir5
ir21 = 8.08
ir22 = cpspch(ir21)
 event_i "i", 21, 2.75, 0.25, 0.4, ir22, ir5
ir25 = 8.07
ir26 = cpspch(ir25)
 event_i "i", 21, 3.0, 1.25, 0.4, ir26, ir5
 event_i "i", 21, 4.25, 0.25, 0.4, ir10, ir5
 event_i "i", 21, 4.5, 1.25, 0.4, ir26, ir5
 event_i "i", 21, 5.75, 0.25, 0.4, ir22, ir5
 event_i "i", 21, 6.0, 1.25, 0.4, ir26, ir5
 event_i "i", 21, 7.25, 0.25, 0.4, ir10, ir5
ir39 = 8.04
ir40 = cpspch(ir39)
 event_i "i", 21, 7.5, 1.25, 0.4, ir40, ir5
 event_i "i", 21, 8.75, 0.25, 0.4, ir10, ir5
 event_i "i", 21, 9.0, 3.0, 0.4, ir14, ir5
 event_i "i", 21, 12.0, 1.25, 0.4, ir10, ir5
 event_i "i", 21, 13.25, 0.25, 0.4, ir22, ir5
 event_i "i", 21, 13.5, 1.25, 0.4, ir26, ir5
 event_i "i", 21, 14.75, 0.25, 0.4, ir10, ir5
ir55 = 9.01
ir56 = cpspch(ir55)
 event_i "i", 21, 15.0, 1.25, 0.4, ir56, ir5
 event_i "i", 21, 16.25, 0.25, 0.4, ir18, ir5
 event_i "i", 21, 16.5, 1.25, 0.4, ir22, ir5
 event_i "i", 21, 17.75, 0.25, 0.4, ir26, ir5
 event_i "i", 21, 18.0, 1.25, 0.4, ir10, ir5
 event_i "i", 21, 19.25, 0.25, 0.4, ir26, ir5
 event_i "i", 21, 19.5, 1.25, 0.4, ir22, ir5
 event_i "i", 21, 20.75, 0.25, 0.4, ir18, ir5
 event_i "i", 21, 21.0, 3.0, 0.4, ir14, ir5
krl0 = 2.0
kr0 = krl0
S79 sprintf "alive_%d", ir5
 chnset kr0, S79
ir82 FreePort 
 event_i "i", 22, 24.0, 24.0, ir82, ir1
 event_i "i", 21, 24.0, 1.25, 0.4, ir10, ir82
 event_i "i", 21, 25.25, 0.25, 0.4, ir14, ir82
 event_i "i", 21, 25.5, 1.25, 0.4, ir18, ir82
 event_i "i", 21, 26.75, 0.25, 0.4, ir22, ir82
 event_i "i", 21, 27.0, 1.25, 0.4, ir26, ir82
 event_i "i", 21, 28.25, 0.25, 0.4, ir10, ir82
 event_i "i", 21, 28.5, 1.25, 0.4, ir26, ir82
 event_i "i", 21, 29.75, 0.25, 0.4, ir22, ir82
 event_i "i", 21, 30.0, 1.25, 0.4, ir26, ir82
 event_i "i", 21, 31.25, 0.25, 0.4, ir10, ir82
 event_i "i", 21, 31.5, 1.25, 0.4, ir40, ir82
 event_i "i", 21, 32.75, 0.25, 0.4, ir10, ir82
 event_i "i", 21, 33.0, 3.0, 0.4, ir14, ir82
 event_i "i", 21, 36.0, 1.25, 0.4, ir10, ir82
 event_i "i", 21, 37.25, 0.25, 0.4, ir22, ir82
 event_i "i", 21, 37.5, 1.25, 0.4, ir26, ir82
 event_i "i", 21, 38.75, 0.25, 0.4, ir10, ir82
 event_i "i", 21, 39.0, 1.25, 0.4, ir56, ir82
 event_i "i", 21, 40.25, 0.25, 0.4, ir18, ir82
 event_i "i", 21, 40.5, 1.25, 0.4, ir22, ir82
 event_i "i", 21, 41.75, 0.25, 0.4, ir26, ir82
 event_i "i", 21, 42.0, 1.25, 0.4, ir10, ir82
 event_i "i", 21, 43.25, 0.25, 0.4, ir26, ir82
 event_i "i", 21, 43.5, 1.25, 0.4, ir22, ir82
 event_i "i", 21, 44.75, 0.25, 0.4, ir18, ir82
 event_i "i", 21, 45.0, 3.0, 0.4, ir14, ir82
krl0 = 2.0
kr0 = krl0
S142 sprintf "alive_%d", ir82
 chnset kr0, S142
ir145 FreePort 
 event_i "i", 22, 48.0, 24.0, ir145, ir1
 event_i "i", 21, 48.0, 1.25, 0.4, ir10, ir145
 event_i "i", 21, 49.25, 0.25, 0.4, ir14, ir145
 event_i "i", 21, 49.5, 1.25, 0.4, ir18, ir145
 event_i "i", 21, 50.75, 0.25, 0.4, ir22, ir145
 event_i "i", 21, 51.0, 1.25, 0.4, ir26, ir145
 event_i "i", 21, 52.25, 0.25, 0.4, ir10, ir145
 event_i "i", 21, 52.5, 1.25, 0.4, ir26, ir145
 event_i "i", 21, 53.75, 0.25, 0.4, ir22, ir145
 event_i "i", 21, 54.0, 1.25, 0.4, ir26, ir145
 event_i "i", 21, 55.25, 0.25, 0.4, ir10, ir145
 event_i "i", 21, 55.5, 1.25, 0.4, ir40, ir145
 event_i "i", 21, 56.75, 0.25, 0.4, ir10, ir145
 event_i "i", 21, 57.0, 3.0, 0.4, ir14, ir145
 event_i "i", 21, 60.0, 1.25, 0.4, ir10, ir145
 event_i "i", 21, 61.25, 0.25, 0.4, ir22, ir145
 event_i "i", 21, 61.5, 1.25, 0.4, ir26, ir145
 event_i "i", 21, 62.75, 0.25, 0.4, ir10, ir145
 event_i "i", 21, 63.0, 1.25, 0.4, ir56, ir145
 event_i "i", 21, 64.25, 0.25, 0.4, ir18, ir145
 event_i "i", 21, 64.5, 1.25, 0.4, ir22, ir145
 event_i "i", 21, 65.75, 0.25, 0.4, ir26, ir145
 event_i "i", 21, 66.0, 1.25, 0.4, ir10, ir145
 event_i "i", 21, 67.25, 0.25, 0.4, ir26, ir145
 event_i "i", 21, 67.5, 1.25, 0.4, ir22, ir145
 event_i "i", 21, 68.75, 0.25, 0.4, ir18, ir145
 event_i "i", 21, 69.0, 3.0, 0.4, ir14, ir145
krl0 = 2.0
kr0 = krl0
S205 sprintf "alive_%d", ir145
 chnset kr0, S205
ir208 FreePort 
 event_i "i", 22, 72.0, 24.0, ir208, ir1
 event_i "i", 21, 72.0, 1.25, 0.4, ir10, ir208
 event_i "i", 21, 73.25, 0.25, 0.4, ir14, ir208
 event_i "i", 21, 73.5, 1.25, 0.4, ir18, ir208
 event_i "i", 21, 74.75, 0.25, 0.4, ir22, ir208
 event_i "i", 21, 75.0, 1.25, 0.4, ir26, ir208
 event_i "i", 21, 76.25, 0.25, 0.4, ir10, ir208
 event_i "i", 21, 76.5, 1.25, 0.4, ir26, ir208
 event_i "i", 21, 77.75, 0.25, 0.4, ir22, ir208
 event_i "i", 21, 78.0, 1.25, 0.4, ir26, ir208
 event_i "i", 21, 79.25, 0.25, 0.4, ir10, ir208
 event_i "i", 21, 79.5, 1.25, 0.4, ir40, ir208
 event_i "i", 21, 80.75, 0.25, 0.4, ir10, ir208
 event_i "i", 21, 81.0, 3.0, 0.4, ir14, ir208
 event_i "i", 21, 84.0, 1.25, 0.4, ir10, ir208
 event_i "i", 21, 85.25, 0.25, 0.4, ir22, ir208
 event_i "i", 21, 85.5, 1.25, 0.4, ir26, ir208
 event_i "i", 21, 86.75, 0.25, 0.4, ir10, ir208
 event_i "i", 21, 87.0, 1.25, 0.4, ir56, ir208
 event_i "i", 21, 88.25, 0.25, 0.4, ir18, ir208
 event_i "i", 21, 88.5, 1.25, 0.4, ir22, ir208
 event_i "i", 21, 89.75, 0.25, 0.4, ir26, ir208
 event_i "i", 21, 90.0, 1.25, 0.4, ir10, ir208
 event_i "i", 21, 91.25, 0.25, 0.4, ir26, ir208
 event_i "i", 21, 91.5, 1.25, 0.4, ir22, ir208
 event_i "i", 21, 92.75, 0.25, 0.4, ir18, ir208
 event_i "i", 21, 93.0, 3.0, 0.4, ir14, ir208
krl0 = 2.0
kr0 = krl0
S268 sprintf "alive_%d", ir208
 chnset kr0, S268
ir271 FreePort 
 event_i "i", 22, 96.0, 24.0, ir271, ir1
 event_i "i", 21, 96.0, 1.25, 0.4, ir10, ir271
 event_i "i", 21, 97.25, 0.25, 0.4, ir14, ir271
 event_i "i", 21, 97.5, 1.25, 0.4, ir18, ir271
 event_i "i", 21, 98.75, 0.25, 0.4, ir22, ir271
 event_i "i", 21, 99.0, 1.25, 0.4, ir26, ir271
 event_i "i", 21, 100.25, 0.25, 0.4, ir10, ir271
 event_i "i", 21, 100.5, 1.25, 0.4, ir26, ir271
 event_i "i", 21, 101.75, 0.25, 0.4, ir22, ir271
 event_i "i", 21, 102.0, 1.25, 0.4, ir26, ir271
 event_i "i", 21, 103.25, 0.25, 0.4, ir10, ir271
 event_i "i", 21, 103.5, 1.25, 0.4, ir40, ir271
 event_i "i", 21, 104.75, 0.25, 0.4, ir10, ir271
 event_i "i", 21, 105.0, 3.0, 0.4, ir14, ir271
 event_i "i", 21, 108.0, 1.25, 0.4, ir10, ir271
 event_i "i", 21, 109.25, 0.25, 0.4, ir22, ir271
 event_i "i", 21, 109.5, 1.25, 0.4, ir26, ir271
 event_i "i", 21, 110.75, 0.25, 0.4, ir10, ir271
 event_i "i", 21, 111.0, 1.25, 0.4, ir56, ir271
 event_i "i", 21, 112.25, 0.25, 0.4, ir18, ir271
 event_i "i", 21, 112.5, 1.25, 0.4, ir22, ir271
 event_i "i", 21, 113.75, 0.25, 0.4, ir26, ir271
 event_i "i", 21, 114.0, 1.25, 0.4, ir10, ir271
 event_i "i", 21, 115.25, 0.25, 0.4, ir26, ir271
 event_i "i", 21, 115.5, 1.25, 0.4, ir22, ir271
 event_i "i", 21, 116.75, 0.25, 0.4, ir18, ir271
 event_i "i", 21, 117.0, 3.0, 0.4, ir14, ir271
krl0 = 2.0
kr0 = krl0
S331 sprintf "alive_%d", ir271
 chnset kr0, S331
ir334 FreePort 
 event_i "i", 22, 120.0, 24.0, ir334, ir1
 event_i "i", 21, 120.0, 1.25, 0.4, ir10, ir334
 event_i "i", 21, 121.25, 0.25, 0.4, ir14, ir334
 event_i "i", 21, 121.5, 1.25, 0.4, ir18, ir334
 event_i "i", 21, 122.75, 0.25, 0.4, ir22, ir334
 event_i "i", 21, 123.0, 1.25, 0.4, ir26, ir334
 event_i "i", 21, 124.25, 0.25, 0.4, ir10, ir334
 event_i "i", 21, 124.5, 1.25, 0.4, ir26, ir334
 event_i "i", 21, 125.75, 0.25, 0.4, ir22, ir334
 event_i "i", 21, 126.0, 1.25, 0.4, ir26, ir334
 event_i "i", 21, 127.25, 0.25, 0.4, ir10, ir334
 event_i "i", 21, 127.5, 1.25, 0.4, ir40, ir334
 event_i "i", 21, 128.75, 0.25, 0.4, ir10, ir334
 event_i "i", 21, 129.0, 3.0, 0.4, ir14, ir334
 event_i "i", 21, 132.0, 1.25, 0.4, ir10, ir334
 event_i "i", 21, 133.25, 0.25, 0.4, ir22, ir334
 event_i "i", 21, 133.5, 1.25, 0.4, ir26, ir334
 event_i "i", 21, 134.75, 0.25, 0.4, ir10, ir334
 event_i "i", 21, 135.0, 1.25, 0.4, ir56, ir334
 event_i "i", 21, 136.25, 0.25, 0.4, ir18, ir334
 event_i "i", 21, 136.5, 1.25, 0.4, ir22, ir334
 event_i "i", 21, 137.75, 0.25, 0.4, ir26, ir334
 event_i "i", 21, 138.0, 1.25, 0.4, ir10, ir334
 event_i "i", 21, 139.25, 0.25, 0.4, ir26, ir334
 event_i "i", 21, 139.5, 1.25, 0.4, ir22, ir334
 event_i "i", 21, 140.75, 0.25, 0.4, ir18, ir334
 event_i "i", 21, 141.0, 3.0, 0.4, ir14, ir334
krl0 = 2.0
kr0 = krl0
S394 sprintf "alive_%d", ir334
 chnset kr0, S394
ir397 FreePort 
 event_i "i", 22, 144.0, 24.0, ir397, ir1
 event_i "i", 21, 144.0, 1.25, 0.4, ir10, ir397
 event_i "i", 21, 145.25, 0.25, 0.4, ir14, ir397
 event_i "i", 21, 145.5, 1.25, 0.4, ir18, ir397
 event_i "i", 21, 146.75, 0.25, 0.4, ir22, ir397
 event_i "i", 21, 147.0, 1.25, 0.4, ir26, ir397
 event_i "i", 21, 148.25, 0.25, 0.4, ir10, ir397
 event_i "i", 21, 148.5, 1.25, 0.4, ir26, ir397
 event_i "i", 21, 149.75, 0.25, 0.4, ir22, ir397
 event_i "i", 21, 150.0, 1.25, 0.4, ir26, ir397
 event_i "i", 21, 151.25, 0.25, 0.4, ir10, ir397
 event_i "i", 21, 151.5, 1.25, 0.4, ir40, ir397
 event_i "i", 21, 152.75, 0.25, 0.4, ir10, ir397
 event_i "i", 21, 153.0, 3.0, 0.4, ir14, ir397
 event_i "i", 21, 156.0, 1.25, 0.4, ir10, ir397
 event_i "i", 21, 157.25, 0.25, 0.4, ir22, ir397
 event_i "i", 21, 157.5, 1.25, 0.4, ir26, ir397
 event_i "i", 21, 158.75, 0.25, 0.4, ir10, ir397
 event_i "i", 21, 159.0, 1.25, 0.4, ir56, ir397
 event_i "i", 21, 160.25, 0.25, 0.4, ir18, ir397
 event_i "i", 21, 160.5, 1.25, 0.4, ir22, ir397
 event_i "i", 21, 161.75, 0.25, 0.4, ir26, ir397
 event_i "i", 21, 162.0, 1.25, 0.4, ir10, ir397
 event_i "i", 21, 163.25, 0.25, 0.4, ir26, ir397
 event_i "i", 21, 163.5, 1.25, 0.4, ir22, ir397
 event_i "i", 21, 164.75, 0.25, 0.4, ir18, ir397
 event_i "i", 21, 165.0, 3.0, 0.4, ir14, ir397
krl0 = 2.0
kr0 = krl0
S457 sprintf "alive_%d", ir397
 chnset kr0, S457
ir460 FreePort 
 event_i "i", 22, 168.0, 24.0, ir460, ir1
 event_i "i", 21, 168.0, 1.25, 0.4, ir10, ir460
 event_i "i", 21, 169.25, 0.25, 0.4, ir14, ir460
 event_i "i", 21, 169.5, 1.25, 0.4, ir18, ir460
 event_i "i", 21, 170.75, 0.25, 0.4, ir22, ir460
 event_i "i", 21, 171.0, 1.25, 0.4, ir26, ir460
 event_i "i", 21, 172.25, 0.25, 0.4, ir10, ir460
 event_i "i", 21, 172.5, 1.25, 0.4, ir26, ir460
 event_i "i", 21, 173.75, 0.25, 0.4, ir22, ir460
 event_i "i", 21, 174.0, 1.25, 0.4, ir26, ir460
 event_i "i", 21, 175.25, 0.25, 0.4, ir10, ir460
 event_i "i", 21, 175.5, 1.25, 0.4, ir40, ir460
 event_i "i", 21, 176.75, 0.25, 0.4, ir10, ir460
 event_i "i", 21, 177.0, 3.0, 0.4, ir14, ir460
 event_i "i", 21, 180.0, 1.25, 0.4, ir10, ir460
 event_i "i", 21, 181.25, 0.25, 0.4, ir22, ir460
 event_i "i", 21, 181.5, 1.25, 0.4, ir26, ir460
 event_i "i", 21, 182.75, 0.25, 0.4, ir10, ir460
 event_i "i", 21, 183.0, 1.25, 0.4, ir56, ir460
 event_i "i", 21, 184.25, 0.25, 0.4, ir18, ir460
 event_i "i", 21, 184.5, 1.25, 0.4, ir22, ir460
 event_i "i", 21, 185.75, 0.25, 0.4, ir26, ir460
 event_i "i", 21, 186.0, 1.25, 0.4, ir10, ir460
 event_i "i", 21, 187.25, 0.25, 0.4, ir26, ir460
 event_i "i", 21, 187.5, 1.25, 0.4, ir22, ir460
 event_i "i", 21, 188.75, 0.25, 0.4, ir18, ir460
 event_i "i", 21, 189.0, 3.0, 0.4, ir14, ir460
krl0 = 2.0
kr0 = krl0
S520 sprintf "alive_%d", ir460
 chnset kr0, S520
ir523 FreePort 
 event_i "i", 22, 192.0, 24.0, ir523, ir1
 event_i "i", 21, 192.0, 1.25, 0.4, ir10, ir523
 event_i "i", 21, 193.25, 0.25, 0.4, ir14, ir523
 event_i "i", 21, 193.5, 1.25, 0.4, ir18, ir523
 event_i "i", 21, 194.75, 0.25, 0.4, ir22, ir523
 event_i "i", 21, 195.0, 1.25, 0.4, ir26, ir523
 event_i "i", 21, 196.25, 0.25, 0.4, ir10, ir523
 event_i "i", 21, 196.5, 1.25, 0.4, ir26, ir523
 event_i "i", 21, 197.75, 0.25, 0.4, ir22, ir523
 event_i "i", 21, 198.0, 1.25, 0.4, ir26, ir523
 event_i "i", 21, 199.25, 0.25, 0.4, ir10, ir523
 event_i "i", 21, 199.5, 1.25, 0.4, ir40, ir523
 event_i "i", 21, 200.75, 0.25, 0.4, ir10, ir523
 event_i "i", 21, 201.0, 3.0, 0.4, ir14, ir523
 event_i "i", 21, 204.0, 1.25, 0.4, ir10, ir523
 event_i "i", 21, 205.25, 0.25, 0.4, ir22, ir523
 event_i "i", 21, 205.5, 1.25, 0.4, ir26, ir523
 event_i "i", 21, 206.75, 0.25, 0.4, ir10, ir523
 event_i "i", 21, 207.0, 1.25, 0.4, ir56, ir523
 event_i "i", 21, 208.25, 0.25, 0.4, ir18, ir523
 event_i "i", 21, 208.5, 1.25, 0.4, ir22, ir523
 event_i "i", 21, 209.75, 0.25, 0.4, ir26, ir523
 event_i "i", 21, 210.0, 1.25, 0.4, ir10, ir523
 event_i "i", 21, 211.25, 0.25, 0.4, ir26, ir523
 event_i "i", 21, 211.5, 1.25, 0.4, ir22, ir523
 event_i "i", 21, 212.75, 0.25, 0.4, ir18, ir523
 event_i "i", 21, 213.0, 3.0, 0.4, ir14, ir523
krl0 = 2.0
kr0 = krl0
S583 sprintf "alive_%d", ir523
 chnset kr0, S583
ir586 FreePort 
 event_i "i", 22, 216.0, 24.0, ir586, ir1
 event_i "i", 21, 216.0, 1.25, 0.4, ir10, ir586
 event_i "i", 21, 217.25, 0.25, 0.4, ir14, ir586
 event_i "i", 21, 217.5, 1.25, 0.4, ir18, ir586
 event_i "i", 21, 218.75, 0.25, 0.4, ir22, ir586
 event_i "i", 21, 219.0, 1.25, 0.4, ir26, ir586
 event_i "i", 21, 220.25, 0.25, 0.4, ir10, ir586
 event_i "i", 21, 220.5, 1.25, 0.4, ir26, ir586
 event_i "i", 21, 221.75, 0.25, 0.4, ir22, ir586
 event_i "i", 21, 222.0, 1.25, 0.4, ir26, ir586
 event_i "i", 21, 223.25, 0.25, 0.4, ir10, ir586
 event_i "i", 21, 223.5, 1.25, 0.4, ir40, ir586
 event_i "i", 21, 224.75, 0.25, 0.4, ir10, ir586
 event_i "i", 21, 225.0, 3.0, 0.4, ir14, ir586
 event_i "i", 21, 228.0, 1.25, 0.4, ir10, ir586
 event_i "i", 21, 229.25, 0.25, 0.4, ir22, ir586
 event_i "i", 21, 229.5, 1.25, 0.4, ir26, ir586
 event_i "i", 21, 230.75, 0.25, 0.4, ir10, ir586
 event_i "i", 21, 231.0, 1.25, 0.4, ir56, ir586
 event_i "i", 21, 232.25, 0.25, 0.4, ir18, ir586
 event_i "i", 21, 232.5, 1.25, 0.4, ir22, ir586
 event_i "i", 21, 233.75, 0.25, 0.4, ir26, ir586
 event_i "i", 21, 234.0, 1.25, 0.4, ir10, ir586
 event_i "i", 21, 235.25, 0.25, 0.4, ir26, ir586
 event_i "i", 21, 235.5, 1.25, 0.4, ir22, ir586
 event_i "i", 21, 236.75, 0.25, 0.4, ir18, ir586
 event_i "i", 21, 237.0, 3.0, 0.4, ir14, ir586
krl0 = 2.0
kr0 = krl0
S646 sprintf "alive_%d", ir586
 chnset kr0, S646
krl0 = 20.0
kr0 = krl0
S653 sprintf "alive_%d", ir1
 chnset kr0, S653
S656 sprintf "p1_%d", ir1
ar0 chnget S656
S659 sprintf "p2_%d", ir1
ar1 chnget S659
 chnclear S656
 chnclear S659
arl1 init 0.0
